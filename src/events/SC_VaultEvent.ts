...
export abstract class SC_VaultEvent extends SC_Event {
    ...
    protected getTrigger(t_shell_command: TShellCommand) {
        return async (file: TAbstractFile, ...extra_arguments: any[] /* Needed for SC_Event_FileRenamed and SC_Event_FolderRenamed to be able to define an additional parameter.*/) => {
